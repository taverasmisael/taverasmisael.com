...
Este, de mis favoritos también y lo llegué a mencionar en el post de [ES6 y más allá parte 2](/blog/javascript-todo-lo-nuevo-desde-es6-hasta-hoy-parte-2#optional-chaining) (en la parte de más allá). **Di adiós a las pirámides de código con un montón de ifs anidados para verificar si una propiedad existe.** Con el optional chaining operator (`.?`) puedes acceder a propiedades anidadas sin preocuparte por errores.
...
- **globalThis**: del que ya hablé [aquí](/blog/javascript-todo-lo-nuevo-desde-es6-hasta-hoy-parte-2#otras-cosas-para-el-futuro-de-javascript).
- **Estandarización** en el orden que `for in` funciona. Si quieres saber más sobre los bucles for, aquí te dejo [un post donde explico todo.](/blog/domina-todos-los-bucles-for-en-que-hay-en-java-script)
- **Métodos privados en clases**: De los que hablo [acá](/blog/javascript-todo-lo-nuevo-desde-es6-hasta-hoy-parte-2#metodos-estaticos-y-valores-privados-en-clases).
