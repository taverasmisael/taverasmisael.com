...
El contexto del post va a estar en **JavaScript**, que si bien no es un lenguaje puramente funcional su naturaleza nos permite aplicar la mayoría de estos patrones, ya sea directamente o a través de librerías.

</Blockquote>

Puedes ver, editar, forkear todos los ejemplos (y un extra) en este sandbox que he creado.

<SourceButtons demoURL="https://codesandbox.io/s/introduccion-a-la-programacion-funcional-kzxjh?file=/src/index.js" />
