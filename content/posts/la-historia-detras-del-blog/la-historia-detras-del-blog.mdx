...
Puedes también hacer un fork del proyecto, hacer cambios, mejoras que creas convenientes y crear un PR para ser revisado. Por ahi viene [Hacktoberfest](/blog/hacktoberfest-ya-esta-aqui) 👀 atentos.
