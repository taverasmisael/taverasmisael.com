...
<FullWidthBlock withContainer class="bg-blue-50 px-8 py-12 bg-gradient-to-tl from-blue-100 to-blue-50 dark:from-slate-900 dark:to-slate-950 dark:bg-slate-900 md:py-24">
    <div class="lg:grid lg:items-center xl:items-start lg:grid-cols-2 lg:gap-4">
      <h1 class="!mt-0 text-4xl font-bold !leading-snug dark:text-slate-100 max-w-2xl">Hi, I'm Misael Taveras. <span class="text-red-500 underline underline-offset-8">I love</span> building stuff with code that you can enjoy <span class="text-blue-600 dark:text-blue-500">on your browser.</span></h1>
