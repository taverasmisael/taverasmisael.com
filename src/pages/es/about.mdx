...
<FullWidthBlock withContainer class="gradient-slate-slate bg-gradient-to-t dark:gradient-gray-slate dark:prose-blockquote:border-gray-700 prose-blockquote:border-gray-400 prose-blockquote:opacity-80">
