...
export default function TestimonialPlayer() {
  return (
    <div id="player" class="relative grid grid-cols-3 items-center gap-2 px-2 md:gap-4">
      <div id="progress-bar" class="absolute -top-3 left-0 h-1 w-full overflow-hidden rounded bg-slate-400 dark:bg-slate-700">
        <div id="progress" class="absolute left-0 top-0 h-1 w-1/2 rounded bg-red-400 dark:bg-red-50"></div>
      </div>
      <div id="current" class="col-span-2 inline-flex items-center space-x-2">
