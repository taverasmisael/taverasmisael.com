              ...
              {item => (
                <li>
                  {item.type === "link" ? (
                    <a
                      href={item.href}
                      class="block rounded p-2 text-sm transition-color active:bg-slate-200 focus:bg-slate-200 hover:bg-slate-100 md:p-4 md:text-lg active:text-blue-700 dark:text-slate-100 focus:text-blue-700 hover:text-blue-700 focus-visible:outline-none dark:active:bg-slate-800 dark:focus:bg-slate-800 dark:hover:bg-slate-800 dark:active:text-blue-50 dark:focus:text-blue-50 dark:hover:text-blue-50"
                    >
