...
export default function ImageTemplate(props: Props) {
  return (
    <div
      class="relative h-[630px] w-[1200px] flex flex-col items-center justify-center bg-cover py-8 font-sans text-slate-900"
      style={{ "background-image": `url("${props.image}")` }}
    >
      <div class="absolute inset-0 flex bg-black/30"></div>

      <div class="relative mx-auto max-w-4xl w-full flex flex-col border-2 border-blue-400 rounded-lg bg-blue-50 p-12">
