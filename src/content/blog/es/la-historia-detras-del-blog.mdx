...
banner: ../../../assets/posts/la-historia-detras-del-blog-banner.jpg
---

![El primer commit para este blog fue creado por Gatsby el 21 de Julio](../../../assets/posts/initial-commit.jpg)
...
- Ya tenía casi un año con el [dominio](https://taverasmisael.com) comprado sin usarlo para nada más que algunos experimentos sencillos con [GitHub Pages](https://pages.github.com/).
...
No sabía nada de Gatsby, pero si de react, así que fui directo al punto, siguiendo mi [formula para aprender](aprendiendo-a-aprender) algo nuevo. Busqué algunos contenidos generales, comparativas hasta que decidí invertir casi 5 horas en un [mini bootcamp](https://www.youtube.com/watch?v=8t0vNu2fCCM&t=10933s&utm_source=taverasmisael) que me puso en el camino correcto.
...
![Checks de Netlify](../../../assets/posts/netlify-checks.jpg)

## El compromiso

La meta era lanzar el blog antes que se acabara el mes, y es por eso que el mismo primero de Agosto subí [mi primera entrada](lanzando-mi-pagina-hoy) a las 1:53 (AST).

[![Commit de la primera entrada](../../../assets/posts/first-entry-commit.jpg)](https://github.com/taverasmisael/taverasmisael/commit/35317b6706f264fafaf73328f4eb4b495ed3926f "Commit de la primera entrada")
...
![Screenshot de la primera versión](../../../assets/posts/launch-screenshot.jpg)
...
Desde la primera entrada que subí, mi deseo de seguir compartiendo creció y creció. Al ir viendo la evolución de la página me fui sintiendo cada vez mejor.
...
![Plantillas para issues](../../../assets/posts/issue-templates.jpg)

Puedes también hacer un fork del proyecto, hacer cambios, mejoras que creas convenientes y crear un PR para ser revisado. Por ahi viene [Hacktoberfest](hacktoberfest-ya-esta-aqui) 👀 atentos.

## Conclusión

![Puntuación de 99% en google](../../../assets/posts/lighthouse-rate.jpg)
