...
_Creé una versión en inglés de este post en [Medium](https://medium.com/@taverasmisael/understanding-jest-snapshots-408858204710)_
...
En este articulo hemos explorado una de las herramientas que tenemos a la mano para crear tests con más facilidad. **Si eliminamos la fricción que existe para empezar a crear test, es más probable que empecemos a hacerlos.** Ya no hay excusas para no agregar tests a tus aplicaciones.
