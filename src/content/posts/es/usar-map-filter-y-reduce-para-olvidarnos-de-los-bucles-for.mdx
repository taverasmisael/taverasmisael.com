...
banner: ../../../assets/posts/banner-usar-map-filter-y-reduce-para-olvidarnos-de-los-bucles-for.jpg
---
...
<Admonition type="tip">
  Visita mi post donde explico con [más detalles las arrow functions](javascript-todo-lo-nuevo-desde-es6-hasta-hoy-parte-1#arrow-functions).
</Admonition>
